...
description: UI polish, component design, animation decisions, and invisible details that make software feel great. Covers easing, springs, gestures, performance, accessibility, and the philosophy of taste in interfaces.
...
Use this skill when:
- Building or reviewing UI components with attention to motion and feel
- Deciding whether an element should animate, and how
- Choosing easing curves, durations, spring configs
- Reviewing animation code for craft and performance
- Building drag/swipe/gesture interactions
- Polishing buttons, popovers, tooltips, toasts, drawers
