...
description: Upgrades existing websites to premium quality. Full audit workflow covering typography, color, layout, interactivity, content, components, iconography, code quality, strategic omissions, and priority upgrade techniques. Works with any CSS framework.
...
1. **Scan** — Read the codebase. Identify framework, styling method (Tailwind, vanilla CSS, styled-components, etc.), and current design patterns.
...
- **Inconsistent vertical rhythm in side-by-side elements.** When placing cards, columns, or panels next to each other, align shared elements across all items.
